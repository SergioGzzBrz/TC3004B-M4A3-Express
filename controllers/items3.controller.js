...
import { collection, documentId, getDocs, query, where, doc, setDoc, getDoc, addDoc, updateDoc, deleteDoc } from "firebase/firestore";
...
export const getItem = async (req, res) => {
    const q = query(collection(db, "items"), where(documentId(), "==", req.params.id));
